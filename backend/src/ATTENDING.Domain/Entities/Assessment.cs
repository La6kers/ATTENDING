...
///
/// ── Patent 14 Mapping: Emergency Triage Intelligence ──────────────────────
/// This entity implements the reduction-to-practice for Patent 14 ("Emergency
/// Triage Intelligence"), which covers an AI-powered system that analyzes
/// patient presentation data to generate prioritized differential diagnoses
/// with red flag detection.
///
/// Patent 14 claim elements mapped to this entity:
///   Claim 1 — AI analysis of patient presentation → DifferentialDiagnosisJson
///             (generated by TieredClinicalIntelligenceService from chief complaint,
///             HPI, ROS, and history data stored in this entity)
///   Claim 2 — Prioritized differential diagnoses → DifferentialDiagnosisJson
///             (ranked list with probability scores, stored as JSON)
///   Claim 3 — Red flag detection with severity → HasRedFlags, RedFlagsJson
///             (populated by RedFlagEvaluator domain service; each flag carries
///             Category, Severity, and ClinicalReason)
///   Claim 4 — Triage level assignment → TriageLevel (ESI 1-5 enum)
///   Claim 5 — AI confidence scoring → DifferentialDiagnosisJson includes
///             per-diagnosis confidence scores from the AI pipeline
///   Claim 6 — Emergency protocol triggering → IsEmergency, EmergencyReason
///             (auto-triggered when RedFlagEvaluator detects critical flags)
///
/// Supporting domain services:
///   - RedFlagEvaluator (ATTENDING.Domain.Services) — claim 3
///   - TieredClinicalIntelligenceService (ATTENDING.Infrastructure) — claims 1, 2, 5
///   - DiagnosticReasoningService (ATTENDING.Application) — calibrated probabilities
/// ──────────────────────────────────────────────────────────────────────────
/// </summary>
