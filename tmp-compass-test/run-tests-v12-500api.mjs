...
// Adds psych/substance/encephalopathy conditions
// IDs 2200-2699, mix of peds/adult/geri, ED/UC/PC
// ============================================================
...
async function main() {
  ...
  let md = `# COMPASS Stress Test — 500 API Cases (v12)\n\n`;
  ...
  writeFileSync('tmp-compass-test/results-v12.md', md);
  writeFileSync('tmp-compass-test/results-v12.json', JSON.stringify(results, null, 2));

  console.log(`\n=== RESULTS ===`);
  console.log(`Accuracy: ${accuracy}% (${hits}/${total})`);
  console.log(`Misses: ${misses} | Errors: ${errors}`);
  console.log(`Latency: p50=${p50}ms p95=${p95}ms p99=${p99}ms`);
  console.log(`\nReports written to tmp-compass-test/results-v12.md and results-v12.json`);
}
