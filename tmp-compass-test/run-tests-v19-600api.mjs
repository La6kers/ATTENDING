...
async function main() {
  ...
  let md = `# COMPASS Stress Test — 600 API Cases (v19)\n\n`;
  ...
  writeFileSync('tmp-compass-test/results-v19.md', md);
  writeFileSync('tmp-compass-test/results-v19.json', JSON.stringify(results, null, 2));

  console.log(`\n=== RESULTS ===`);
  console.log(`Accuracy: ${accuracy}% (${hits}/${total})`);
  console.log(`Misses: ${misses} | Errors: ${errors}`);
  console.log(`Latency: p50=${p50}ms p95=${p95}ms p99=${p99}ms`);
  console.log(`\nReports written to tmp-compass-test/results-v19.md and results-v19.json`);
}
