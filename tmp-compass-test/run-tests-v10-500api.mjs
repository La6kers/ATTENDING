...
// Post-fix: HPI array fix, ENT expansions, synonym/prevalence adds
// IDs 1200-1699, mix of peds/adult/geri, ED/UC/PC
// ============================================================
...
async function main() {
  ...
  let md = `# COMPASS Stress Test — 500 API Cases (v10)\n\n`;
  ...
  writeFileSync('tmp-compass-test/results-v10.md', md);
  writeFileSync('tmp-compass-test/results-v10.json', JSON.stringify(results, null, 2));

  console.log(`\n=== RESULTS ===`);
  console.log(`Accuracy: ${accuracy}% (${hits}/${total})`);
  console.log(`Misses: ${misses} | Errors: ${errors}`);
  console.log(`Latency: p50=${p50}ms p95=${p95}ms p99=${p99}ms`);
  console.log(`\nReports written to tmp-compass-test/results-v10.md and results-v10.json`);
}
