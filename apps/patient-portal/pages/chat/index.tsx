...
export default function CompassChatPage() {
  ...
  return (
    <>
      ...
      <div className="h-screen flex flex-col bg-brand-gradient">
        {/* Top Navigation Bar */}
        <header className="bg-white/95 backdrop-blur-md border-b border-purple-100 px-4 py-3 flex items-center justify-between">
        ...
        {/* Footer Disclaimer */}
        <footer className="bg-white/90 backdrop-blur-md border-t border-purple-100 px-4 py-2">
