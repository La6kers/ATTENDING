  ...
  return (
    ...
    >
      ...
      <div className="w-48 flex-shrink-0">
        ...
        <p className="text-sm text-gray-500">{assessment.patientAge}yo {assessment.patientGender} &bull; {assessment.mrn}</p>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">
                {assessment.patientAge}yo {assessment.patientGender} &bull; {assessment.mrn}
              </p>
            </div>
          </div>
...
export default function AssessmentsPage() {
  ...
  return (
    <>
      ...
      <ProviderShell contextBadge="Assessments" currentPage="assessments"
        headerRight={
          <div className="flex items-center gap-2">
            <div className="flex items-center bg-white/10 rounded-lg p-0.5">
              <button
                onClick={() => setViewMode('list')}
                className={`p-1.5 rounded-md transition-colors ${viewMode === 'list' ? 'bg-white text-teal-700' : 'text-white hover:bg-white/10'}`}
                title="List View"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded-md transition-colors ${viewMode === 'card' ? 'bg-white text-teal-700' : 'text-white hover:bg-white/10'}`}
                title="Card View"
              >
