...
export default function SignInPage() {
  ...
  return (
    <>
      ...
      <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#0C3547,#1A8FA8)',display:'flex',alignItems:'center',justifyContent:'center',padding:'1rem'}}>
        <div style={{background:'white',borderRadius:'1rem',padding:'2rem',width:'100%',maxWidth:'400px',textAlign:'center'}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'0.75rem'}}>
            <button onClick={()=>handleLogin('provider')} disabled={isLoading} style={{padding:'1rem',fontSize:'1rem',background:'linear-gradient(180deg,#1A8FA8,#0C4C5E)',color:'white',border:'none',borderRadius:'0.5rem',cursor:'pointer'}}>
