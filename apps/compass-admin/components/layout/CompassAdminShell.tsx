                ...
                {userMenuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border z-50 py-1">
                      <Link href="/settings/checkin" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        <Settings className="w-4 h-4" /> Settings
                      </Link>
                      <Link href="/system" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        <HelpCircle className="w-4 h-4" /> System Health
                      </Link>
                      <hr className="my-1" />
